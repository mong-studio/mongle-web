...
| 상황 | 위치 |
| --- | --- |
| React 화면 UI·상태·이벤트 | `apps/game/src/` |
| Phaser 맵 렌더링 | `apps/game/src/PhaserVillage.tsx` |
| 맵/타일셋/타일 이미지 | `apps/game/public/assets/map/` |
| 화면 스타일 | `apps/game/src/style.css` |
| 새 환경 변수 추가 | `apps/game/.env.example` + `src/vite-env.d.ts` |
